...
class ThemeListCreateView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        if request.query_params.get("type") == "recommended" and request.user.is_authenticated:
            ...
            outcome = ServiceOutcome(ThemeListService, request.GET.dict() )
        return Response({
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            ThemeListSerializer(outcome.result, many=False, context={'user_id': request.user.id}).data,
...
class ThemePopularListView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        outcome = ServiceOutcome(ThemePopularListService, {})
        return Response({
